...
def execute(filters=None):
    ...
    if not filters.evidence_type or filters.evidence_type == "Checklist":
        parts.append(f"""select t.name as task, t.task_name, 'Checklist' as evidence_type,
    ...
    if not filters.evidence_type or filters.evidence_type == "Dynamic Field":
        parts.append(f"""select t.name as task, t.task_name, 'Dynamic Field' as evidence_type,
